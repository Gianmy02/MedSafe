...
public class UserController {
    ...
    @Operation(summary = "Ottieni info utente corrente", description = "Restituisce le informazioni dell'utente autenticato e lo sincronizza automaticamente se nuovo")
    @GetMapping("me")
